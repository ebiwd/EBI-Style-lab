                    ...
                    if (d.length >= set.minimumLength)
                    {
                         ...
                         if (c != 0)
                         {
                              ...
                              for (var i = 0; i < found.length; i++)
                              {
                                   ...
                                   {
                                        out += '<h5 class="padding-top-large margin-bottom-none ebi-color"><a href="../' + found[i].url + '"' + tipue_search_w + '>' +  found[i].title + '</a></h5>';
                                        ...
                                        if (set.showURL)
                                        {
                                             ...
                                             out += '<div class="label secondary-color no-underline"><a href="../' + found[i].url + '"' + tipue_search_w + '>' + s_u + '</a></div>';
                                        }
                                        ...
                                        if (found[i].desc)
                                        {
                                             ...
                                             else if (set.highlightTerms)
                                             {
                                                  ...
                                                  t = t.replace(patr, "<strong class=\"bold\">$1</strong>");
                                             }
                                             ...
                                             t_d = t_d.replace(/h0011/g, 'strong class=\"bold\"');
                              ...
                              if (set.showRelated && standard)
                              {
                                   ...
                                   for (var i = 0; i < tipuesearch_related.searches.length; i++)
                                   {
                                        if (d == tipuesearch_related.searches[i].search)
                                        {
                                             ...
                                             if (!f)
                                             {
                                                  out += '<div class="tipue_search_related_title">' + tipuesearch_string_15 + ' <strong class="tipue_search_related_bold">' + d_o + '</strong></div><div class="tipue_search_related_cols">';
                                             }
                              ...
                              if (c > set.show)
                              {
                                   ...
                                   out += '<nav><div id="tipue_search_foot"><ul id="" class="pagination" role="navigation" aria-label="Pagination">';

                                   if (start > 0)
                                   {
                                       out += '<li role="navigation" class="pagination-previous"><a class="tipue_search_foot_box" accesskey="b" id="' + (start - set.show) + '_' + replace + '">' + tipuesearch_string_6 + '</a></li>';
                                   }
                                   ...
                                   if (page + 1 != pages)
                                   {
                                       out += '<li role="navigation" class="pagination-next"><a class="tipue_search_foot_box" accesskey="m" id="' + (start + set.show) + '_' + replace + '">' + tipuesearch_string_7 + '</a></li>';
                                   }
